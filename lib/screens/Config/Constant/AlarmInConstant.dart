  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(builder: (BuildContext context,BoxConstraints constraints){
      ...
      if(constraints.maxWidth < 900){
        return NormalAlarmInConstantForMobile();
      }
      return myTable(
          [
...
Widget scanTime(BuildContext context,constantPvd,overAllPvd,line,alarm){
  return TextButton(
        ...
        showDialog(context: context, builder: (context){
          return AlertDialog(
            content: HoursMinutesSeconds(
              initialTime: '${constantPvd.alarmUpdated[line]['alarm'][alarm]['scanTime']}',
              onPressed: (){
                constantPvd.alarmFunctionality(['alarm_scanTime',line,alarm,'${overAllPvd.hrs < 10 ? '0' :''}${overAllPvd.hrs}:${overAllPvd.min < 10 ? '0' :''}${overAllPvd.min}:${overAllPvd.sec < 10 ? '0' :''}${overAllPvd.sec}']);
      ...
      child: Text('${constantPvd.alarmUpdated[line]['alarm'][alarm]['scanTime']}',style: TextStyle(color: Colors.black87),)
  );
}
  ...
  return TextButton(
      ...
      onPressed: ()async{
        showDialog(context: context, builder: (context){
          return AlertDialog(
            content: HoursMinutesSeconds(
              initialTime: '${constantPvd.alarmUpdated[line]['alarm'][alarm]['autoResetDuration']}',
              onPressed: (){
                constantPvd.alarmFunctionality(['alarm_auto_reset',line,alarm,'${overAllPvd.hrs < 10 ? '0' :''}${overAllPvd.hrs}:${overAllPvd.min < 10 ? '0' :''}${overAllPvd.min}:${overAllPvd.sec < 10 ? '0' :''}${overAllPvd.sec}']);
                Navigator.pop(context);
              },
            ),
          );
      ...
      child: Text('${constantPvd.alarmUpdated[line]['alarm'][alarm]['autoResetDuration']}',style: TextStyle(color: Colors.black87),)
  );
}


class NormalAlarmInConstantForMobile extends StatefulWidget {
  const NormalAlarmInConstantForMobile({super.key});

  @override
  State<NormalAlarmInConstantForMobile> createState() => _NormalAlarmInConstantForMobileState();
}

class _NormalAlarmInConstantForMobileState extends State<NormalAlarmInConstantForMobile> {
  int selected_Line = 0;
  int alarm_type = 0;
                  ...
                  child: Center(
                    child: ListTile(
                      ...
                      trailing:  PopupMenuButton<int>(
                        ...
                        itemBuilder: (context) => [
                          for(var i = 0;i < constantPvd.alarmUpdated.length;i++)
                            PopupMenuItem(
                                value: i,
                                child: Text('${i+1}')
                            ),
                  ...
                  child: Center(
                    child: ListTile(
                      ...
                      trailing:  PopupMenuButton<int>(
                        ...
                        itemBuilder: (context) => [
                          for(var i = 0;i < constantPvd.alarmUpdated[selected_Line]['alarm'].length;i++)
                            PopupMenuItem(
                                value: i,
                                child: Text('${i+1}')
                            ),
          ...
          Expanded(
            child: GridView.count(
              ...
              children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButton(
                        ...
                        // style: ioText,
                        value: constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['alarmOnStatus'],
                        underline: Container(),
                        ...
                        onChanged: (value) {
                          constantPvd.alarmFunctionality(['alarm_status',selected_Line,alarm_type,value!]);
                        },
                ...
                if(constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['resetAfterIrrigation'] != null)
                  Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      color: Colors.white
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButton(
                        focusColor: Colors.transparent,
                        // style: ioText,
                        value: constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['resetAfterIrrigation'],
                        underline: Container(),
                        ...
                        onChanged: (value) {
                          constantPvd.alarmFunctionality(['alarm_reset_irrigation',selected_Line,alarm_type,value!]);
                        },
                        // After selecting the desired option,it will
                        // change button value to selected value
                ...
                if(constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['name'] != 'NO FLOW' && constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['name'] != 'NO POWER SUPPLY')
                  Container(
                  decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(20),
                      color: Colors.white
                  ...
                  child: Column(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Icon(Icons.local_activity_outlined,color: myTheme.primaryColor,),
                          Text('Threshold ${constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['unit']}'),
                        ],
                      ),
                      SizedBox(width:60,height:55,child: TextFieldForConstant(index: -1, initialValue: constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['threshold'], constantPvd: constantPvd, purpose: 'alarm_threshold/$selected_Line/$alarm_type', inputFormatters: [FilteringTextInputFormatter.allow(RegExp(r'[0-9]'))],)),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${constantPvd.alarmUpdated[selected_Line]['alarm'][alarm_type]['name']}')
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text('${constantPvd.alarmUpdated[selected_Line]['name']}')
                    ],
                  ),
                ),
              ],
