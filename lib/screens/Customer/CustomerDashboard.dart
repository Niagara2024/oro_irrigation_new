...
class _CustomerDashboardState extends State<CustomerDashboard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: myTheme.primaryColorDark.withOpacity(0.1),
      child: Padding(
          ...
          children: [
            ...
            Column(
              children: [
                ...
                Container(
                  width: 340,
                  height: widget.siteLength > 1? MediaQuery.sizeOf(context).height-240 : MediaQuery.sizeOf(context).height-190,
                  decoration: BoxDecoration(
                    gradient: LinearGradient(
                      begin: Alignment.centerRight,
                      end: Alignment.centerLeft,
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: DataTable2(
                          ...
                          headingRowColor: MaterialStateProperty.all<Color>(primaryColorLight.withOpacity(0.2)),
                          columns: const [
                            DataColumn2(
