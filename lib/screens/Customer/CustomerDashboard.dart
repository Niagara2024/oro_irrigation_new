...
class _CustomerDashboardState extends State<CustomerDashboard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(
      ...
      children: [
        Container(
          width: widget.type==0? MediaQuery.sizeOf(context).width-60 : MediaQuery.sizeOf(context).width-140,
            ...
            children: [
              ...
              Container(
                ...
                child: IconButton(
                  ...
                  Icons.wifi, color: wifiStrength == 0? Colors.redAccent : Colors.white,),
                  onPressed: null,
                ),
              ),
              const SizedBox(height: 15),
