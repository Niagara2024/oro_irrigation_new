                  ...
                  DataCell(Center(child: IconButton(tooltip: 'View Relay status',
                    ...
                    onPressed: () {
                      showModalBottomSheet(
                        ...
                        builder: (BuildContext context) {
                          return SizedBox(
                            height: widget.nodeList[index].RlyStatus.length > 8? 275 : 200,
                            child: Column(
                              mainAxisAlignment: MainAxisAlignment.start,
                              children: <Widget>[
                                ListTile(
                                ...
                                SizedBox(
                                  width : double.infinity,
                                  height : widget.nodeList[index].RlyStatus.length > 8? 206 : 130,
                                  child: Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: widget.nodeList[index].RlyStatus.isNotEmpty ? Column(
                                      children: [
                                        const SizedBox(
                                          width: double.infinity,
                                          height : 40,
                                        ...
                                        SizedBox(
                                          width: double.infinity,
                                          height : widget.nodeList[index].RlyStatus.length > 8? 150 : 70,
                                          child: GridView.builder(
                                            ...
                                            itemBuilder: (BuildContext context, int indexGv) {
                                              //print(widget.nodeList[index].rlyStatus[indexGv].s);
                                              return Column(
                                                children: [
                                                  CircleAvatar(
